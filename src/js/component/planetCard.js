...
// Corrected planetCard component
function PlanetCard() {
    ...
    return (
      <div className="d-flex col-10 overflow-auto mt-5 mx-auto cards" style={{ height: "50rem" }}>
        {planets.map((planet, index) => {
          ...
          return (
            <div key={index} className="card col-1 mx-1" style={{ width: "30rem", height: "48rem" }}>
              ...
              <Link to={`/planet_details/${planet.uid}`}>Learn More</Link>
